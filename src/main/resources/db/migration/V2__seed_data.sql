...
INSERT INTO users (id, username, email, passwordhash, status, created_at)
VALUES
(1, 'anvith', 'anvith@gmail.com', 'hashed_password', 'ACTIVE', NOW()),
(2, 'rahul', 'rahul@gmail.com', 'hashed_password', 'ACTIVE', NOW());

INSERT INTO subscriptions (id, user_id, provider_name, category, start_date, renewal_cycle, renewal_date, price, currency, status)
VALUES
...
INSERT INTO recommendations (user_id, subscription_id, type, reason, confidence_score, status, generated_at)
VALUES
...
INSERT INTO billing_records (subscription_id, amount, currency, billing_period, paid_at, payment_method, source, created_at)
VALUES
...
INSERT INTO user_snapshots (subscription_id, period, usage_count, source, created_at)
VALUES
